...
{
	static_cast<sc_simcontext*>(p)->parta();
	return NULL;
}
void sc_simcontext::parta(){
...
sc_simcontext::crunch( bool once )
{
	...
	/*20171215*/
		pthread_create( &t, NULL, staticFunction, this);
		pthread_join( t, NULL);
	/**/
...
//static int crunch_count = 0;
void
sc_simcontext::simulate( const sc_time& duration )
{
	/*std::cout << std::endl;
	std::cout << "******simulate_count********" << std::endl;
	std::cout << simulate_count++ << std::endl;
	std::cout << "****************************" << std::endl;*/
    initialize( true );
    ...
    do {
	/*std::cout << std::endl;
	std::cout << "********crunch_count********" << std::endl;
	std::cout << crunch_count++ << std::endl;
	std::cout << "****************************" << std::endl;*/
	crunch();
	if( m_error ) {
